...
float          emuTimerFrequency = 0.0167f;
...
float          emuFrequency = 0.001f;

int chip8main() {
    char tempString[256];
    sprintf(tempString, "mem:/%u:%i", (unsigned int)invaders, size_invaders);
    emuProgramLoad(tempString);
