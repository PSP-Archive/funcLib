...
#define FL_DEBUG_CALLEDFROM               1 ///< Enables called from info in warnings/errors aswell as in the log.
#define FL_DEBUG_LOGGING                  1 ///< Enable/Disable error logging.
#define FL_DEBUG_LOGCLEAR                 1 ///< Clear old debug logs at start of program.
#define FL_DEBUG_LOGPATH                  "./flDebugLog.txt" ///< Path to error log file.
#define FL_DEBUG_STATUS                   1 ///< Enable/Disable logging of additional events such as program start, etc.
#define FL_DEBUG_STATUS_NOTIFY            1 ///< Enable/Disable showing of status messages in the notification tray.
...
#define FL_DEBUG_WARNING                  1 ///< Enable/Disable warning handling.
#define FL_DEBUG_WARNING_SHOW             0 ///< Enable/Disable visible warnings (Still get logged if logging is enabled).
#define FL_DEBUG_WARNING_NOTIFY           1 ///< Enable/Disable showing of warnings in the notification tray.
...
#define FL_DEBUG_DEVWARNING               1 ///< Enable/Disable dev warning handling.
#define FL_DEBUG_DEVWARNING_SHOW          0 ///< Enable/Disable visible dev warnings (Still get logged if logging is enabled).
#define FL_DEBUG_DEVWARNING_NOTIFY        1 ///< Enable/Disable showing of developer warnings in the notification tray.
...
#define FL_MEMORY_ALIGNMENT_DEFAULT       32 ///< Default alignment (used for memAlloc), should be >= 16 and a binary number (e.g 16, 32, 64, etc.).
...
#define FL_MEMORY_POOL                    1 ///< Include memory pooling module.
...
#define FL_TEXTURE_PCX                       1 ///< Include support for PCX textures.
#define FL_TEXTURE_TGA                       1 ///< Include support for TGA textures.
#define FL_TEXTURE_BMP                       1 ///< Include support for BMP textures.
...
#define FL_TEXTURE_MANIPULATION              1 ///< Include texture manipulation module.

#define FL_MODEL                             1 ///< Include model module.
#define FL_MODEL_OBJ                         1 ///< Include support for OBJ models.
#define FL_MODEL_MD2                         1 ///< Include support for MD2 animated models.

#define FL_SPRITE                            1 ///< Include sprite module.
...
#define FL_COLLISION                         1 ///< Include collision detection module.
