...
// 
// Contributor(s): VRAM code was written from scratch by Flatmush but based off Raphaels idea.
...
#define vmemPtr(inPtr) (((unsigned int)(inPtr) >= MEMORY_VMEM_BASE) && ((unsigned int)(inPtr) < (MEMORY_VMEM_BASE + (MEMORY_VMEM_SIZE << 2))))
